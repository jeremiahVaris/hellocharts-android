...
public class SimpleAxisValueFormatter implements AxisValueFormatter {
    ...
    @Override
    public Spannable formatValueForManualAxis(AxisValue axisValue) {
        return valueFormatterHelper.formatFloatValueWithPrependedAndAppendedText(
                axisValue.getValue(), axisValue.getLabelSpannable());
    }

    @Override
    public Spannable formatValueForAutoGeneratedAxis(float value, int autoDecimalDigits) {
        return valueFormatterHelper.formatFloatValueWithPrependedAndAppendedText(value, autoDecimalDigits);
    }
