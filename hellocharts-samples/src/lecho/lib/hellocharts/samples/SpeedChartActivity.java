...
public class SpeedChartActivity extends ActionBarActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        private static class HeightValueFormatter extends SimpleAxisValueFormatter {
            ...
            @Override
            public Spannable formatValueForAutoGeneratedAxis(float value, int autoDecimalDigits) {
                float scaledValue = (value + sub) / scale;
                return super.formatValueForAutoGeneratedAxis(scaledValue, this.decimalDigits);
            }
        }
